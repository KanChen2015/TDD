...
class LocationTests: XCTestCase {
    ...
    func testInit_ShouldSetNameAndCoordinate() {
        ...
        XCTAssertEqual(location.coordinate?.latitude, testCoordinate.latitude, "Init should set latitude")
        XCTAssertEqual(location.coordinate?.longitude, testCoordinate.longitude, "Init should set longitude")
    }

    func testInit_ShouldSetName() {
        let location = Location(name: "Test name")
        XCTAssertEqual(location.name, "Test name", "Init should set name")
    }
    ...
    func testWhenOneHasCoordinateAndTheOtherOneDosent_ShouldBeNoteEqual() {
        performNotEqualTestWithLocationProperties("Home",
                                                  secondName: "Home",
